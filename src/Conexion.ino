...
// Azure IoT
#define IOT_CONFIG_IOTHUB_FQDN "Monitoreo-SalinidadAguaSensorPH.azure-devices.net" // "test.mosquitto.org"
#define IOT_CONFIG_DEVICE_ID "ESP32"
#define IOT_CONFIG_DEVICE_KEY "VQEQKd8EiM1aoAw77yyyQMXl6p0/cyEuAPV13mooheA="
...
static void getTelemetryPayload(az_span payload, az_span* out_payload)
{
  ...
  (void)az_span_u32toa(payload, telemetry_send_count++, &payload);
    payload = az_span_copy(payload, AZ_SPAN_FROM_STR(", \"PH\": "));
  (void)az_span_u32toa(payload, ph, &payload);
